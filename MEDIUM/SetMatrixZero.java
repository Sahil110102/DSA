...
// 
    ...
    //         for (int j = 0; j < m; j++) {
    //             if (row[i] == 1 || col[j] == 1) {
    //             matrix[i][j] = 0; // Directly set the element at i, j to 0 (avoiding unnecessary object calls)
    //             }
    //         }
    //     }
    // }

    //Better Solution - using two array rows and col 
